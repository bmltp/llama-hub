"""WordpressCustomURLReader reader."""
import json
...
class WordpressCustomURLReader(BaseReader):
    """Wordpress Custom URLreader. Reads data from a Wordpress workspace.

    Args:
        wordpress_subdomain (str): Wordpress subdomain
    """

    def __init__(self, custom_json_url: str, password: str, username: str) -> None:
        """Initialize Wordpress reader."""
        self.url = custom_json_url
    ...
    def load_data(self) -> List[Document]:
        ...
        for article in articles:
            ...
            if body is None:  # rendered can be empty string
    ...
    def get_posts_page(self, current_page: int = 1):
        ...
        url = f"{self.custom_json_url}?per_page=100&page={current_page}"
